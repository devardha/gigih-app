const data = [
	...
	},
	{
		album: {
			...
			external_urls: {
				spotify:
					"https://open.spotify.com/album/6GKO2wiPdGjIpSmWlelmft",
			},
	...
	},
	{
		album: {
			...
			external_urls: {
				spotify:
					"https://open.spotify.com/album/5rOHrnrRomvSJhQLGVtfJ8",
			},
	...
	},
	{
		album: {
			...
			external_urls: {
				spotify:
					"https://open.spotify.com/album/00JpoY0ZaQRXTNJUruibfX",
			},
	...
	},
	{
		album: {
			...
			external_urls: {
				spotify:
					"https://open.spotify.com/album/2eTZer3GBKUF8AZOEqpiMj",
			},
